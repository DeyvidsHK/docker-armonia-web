    ...
    <div class="container">
        ...
        <form style="font-family:var;" action="insertarProducto.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" style="background-color:#FFFFFF;border-color:black;"
            ...
            <div class="mb-3">
                <label for="imagen" class="form-label" style="margin-left:1em;font-style:italic;font-size:20px;"> Imagen
                    del producto :</label>
                <input type="file" name="imagenP" id="imagen" style="background-color:#FFFFFF;border-color:black;"
                    class="form-control" required>
            </div>

            <label for="" style="margin-left:1em;font-style:italic;font-size:20px; ">Categoría :</label>
            <select class="form-select mb-3 " style="background-color:#FFFFFF;border-color:black;" name="CategoriaP" required>
